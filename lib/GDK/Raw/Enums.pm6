...
our enum GdkSeatCapabilitiesEnum is export (
  ...
  GDK_SEAT_CAPABILITY_ALL_POINTING  =>       7, #= GDK_SEAT_CAPABILITY_POINTER +| GDK_SEAT_CAPABILITY_TOUCH +| GDK_SEAT_CAPABILITY_TABLET_STYLUS
  GDK_SEAT_CAPABILITY_ALL           =>      15  #= GDK_SEAT_CAPABILITY_ALL_POINTING | GDK_SEAT_CAPABILITY_KEYBOARD
);
